$(function(){
    ...
    var HeaderMenuHandler = {
        ...
        init : function(){
            ...
            $("li", HeaderMenuHandler.config.menuCommon).each(function(i) {
                $(this).click(function() {
                    HashController.config.cache.isNaviTransition = true;
                });
            });
        }
    };
    ...
    var TabContentHandler = {
        ...
        init : function(){
            ...
            $("a", TabContentHandler.config.triggersRoot).each(function() {
                $(this).click(function() {
                    HashController.config.cache.isNaviTransition = false;
                });
            });
        }
    };
    ...
    var MainViewHandler = {
        ...
        show : function(visibleIdx, animateFlg, warpFlg){
            ...
            switch(entityIdx){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    switch(HashController.config.hash) {
                        case "#satellitewave":
                            // if(TabContentHandler.config.cache.currentIdx == 1) {
                                $("a", TabContentHandler.config.triggersRoot).eq(1).removeClass("currentTab");
                                $("a", TabContentHandler.config.triggersRoot).eq(0).addClass("currentTab");
                                $("#tabContent1").show();
                                $("#tabContent1").css("opacity", 1);
                                $("#tabContent2").hide();
                                $("#tabContent2").css("opacity", 0);
                                TabContentHandler.config.cache.currentIdx = 0;
                            // }
                        break;

                        case "#radiocontrolled":
                            // if(TabContentHandler.config.cache.currentIdx == 1) {
                                $("a", TabContentHandler.config.triggersRoot).eq(0).removeClass("currentTab");
                                $("a", TabContentHandler.config.triggersRoot).eq(1).addClass("currentTab");
                                $("#tabContent1").hide();
                                $("#tabContent1").css("opacity", 0);
                                $("#tabContent2").show();
                                $("#tabContent2").css("opacity", 1);
                                TabContentHandler.config.cache.currentIdx = 1;
                            // }
                        break;
                    ...
                    if(animateFlg){
                        ...
                        MainViewHandler.config.parts.eq(2).css(
                            {
                                'top' : (DeviceHandler.config.cache.spDeviceFlg ? MainViewHandler.config.cache.spHeaderH : 0) + 'px',
                                'height' : (DeviceHandler.config.cache.spDeviceFlg ? MainViewHandler.config.cache.partsH : MainViewHandler.config.cache.partsH + 170) + 'px'
                            }
                        );
                        MainViewHandler.handler.shoMvContent(2);
                    }
        ...
        resize : function(spDeviceFlg){
            ...
            if(spDeviceFlg){
                ...
                if (MainViewHandler.config.cache.partsH<140) {
                    MainViewHandler.config.cache.partsH = 140;
                }
                ...
                (spDeviceFlg ?TabContentHandler.resize(MainViewHandler.config.cache.partsH) : TabContentHandler.resize(MainViewHandler.config.cache.partsH + 85));
            }else{
                ...
                if(BodyScrollHandler.config.currentStatus){
                    MainViewHandler.config.parts.each(function(idx){
                        if(idx != 2){
                            $(this).css(
                                {
                                    'height' : MainViewHandler.config.cache.partsH + 85 + 'px',
                                    'top' : '0px'
                                }
                            );
                        }else{
                ...
                TabContentHandler.resize(MainViewHandler.config.cache.partsH + 85);
            }
        },
        bind : function(){
            ...
            ModalHandler.config.open.on('click', function(){
                if(hashMovedStatus){
                    if(!ModalHandler.config.visibleFlg){
                        ModalHandler.config.root.css("opacity", 0);
            ...
            hashCallBack : function(hash){
                ...
                switch(hash){
                    ...
                    case '#super-titanium' :
                        ...
                        break;
                    case '#satellitewave' :
                        if(!HashController.config.cache.isNaviTransition){
                            hashMovedStatus = true;
                            return;
                        }
                        if(COMMON.cache._b.hasClass(movedMarker)){
