...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="z_seo_article_generate_mess_act.php">
		<div class="AdminEditDetailsBlock">
			<table class="LeftHeaderTable">
				...
				<tr>
					<th>Keyword</th>
					<td><input type="text" name="keyword" value="{$KeywordTagText}" /></td>
				</tr>
				<tr>
					<th>New URL:</th>
