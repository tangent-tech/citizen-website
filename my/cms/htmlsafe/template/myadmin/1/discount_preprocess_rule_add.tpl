...
<h1 class="PageTitle">Add Discount Preprocess Rule</h1>
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="discount_preprocess_rule_add_act.php">
		<div id="DiscountPreprocessRuleTabs">
			<ul>
				<li><a href="#DiscountPreprocessRuleTabsPanel-CommonData">Reference Data</a></li>
				...
				<div class="AdminEditDetailsBlock">
					<table class="LeftHeaderTable">
						...
						<tr>
							...
							<td>
								<input type="radio" name="discount_preprocess_rule_stop_process_below_rules" value="Y" /> Yes
								<input type="radio" name="discount_preprocess_rule_stop_process_below_rules" value="N"  checked="checked" /> No
							</td>
						</tr>
					</table>
				</div>
