...
<h1 class="PageTitle">Add {$Site.site_label_product|ucwords} Root &nbsp;
	<a class="ui-state-default ui-corner-all MyButton" href="product_root_list.php">
		<span class="ui-icon ui-icon-arrowreturnthick-1-e"></span> {$Site.site_label_product|ucwords} Root List
	</a>
</h1>
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<h2 class="ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top InnerHeader">{$Site.site_label_product|ucwords} Root Details </h2>
