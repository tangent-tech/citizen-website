			...
			<table>
				<tr>
					<td width="139mm">
						...
						{if $MyOrder.invoice_city_name != ''}{$MyOrder.invoice_city_name}, {/if}{if $MyOrder.invoice_region != ''}{$MyOrder.invoice_region}, {/if}{if $MyOrder.invoice_postcode != ''}{$MyOrder.invoice_postcode}, {/if}{if $MyOrder.invoice_country_id != $smarty.const.COUNTRY_ID_OTHER}{$InvoiceCountry.country_name_en}{else}{$MyOrder.invoice_country_other}{/if} <br />
						...
						{if $MyOrder.deliver_to_different_address == 'Y'}
							...
							{if $MyOrder.delivery_city_name != ''}{$MyOrder.delivery_city_name}, {/if}{if $MyOrder.delivery_region != ''}{$MyOrder.delivery_region}, {/if}{if $MyOrder.delivery_postcode != ''}{$MyOrder.delivery_postcode}, {/if}{if $MyOrder.delivery_country_id != $smarty.const.COUNTRY_ID_OTHER}{$DeliveryCountry.country_name_en}{else}{$MyOrder.delivery_country_other}{/if}
