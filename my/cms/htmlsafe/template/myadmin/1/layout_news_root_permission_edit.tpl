...
<h1 class="PageTitle">Edit {$LayoutNewsRoot.layout_news_root_name} Permission &nbsp;
	<a class="ui-state-default ui-corner-all MyButton" href="layout_news_list.php?id={$TheObject.layout_news_root_id}">
		<span class="ui-icon ui-icon-arrowreturnthick-1-e"></span> {$LayoutNewsRoot.layout_news_root_name} List
	</a>
</h1>
