...
<div id="LoginContainer" class="ui-widget ui-widget-content ui-corner-all">
	...
	<div id="LoginContainerContent" class="AdminWidgetContent ui-widget-content ui-helper-reset ui-corner-bottom">
		...
		<form action="login.php" method="post">
			<p> <label for="username">電郵:</label> <input type="text" name="username" id="username" /> </p>
			<p> <label for="password">密碼:</label> <input type="password" name="password" id="password" /> </p>
			<input class="ui-state-default ui-corner-all MyInputButton" type="submit" value="登入" />
			<input class="ui-state-default ui-corner-all MyInputButton" type="reset" value="重設" />
		</form>	
	</div>
</div>
