...
<h1 class="PageTitle">{$Site.site_label_layout_news|ucwords} Page - {$ObjectLink.object_name|escape:'html'} &nbsp;
	<a onclick="return confirm('警告! \n 確定刪除？')" class="ui-state-default ui-corner-all MyButton" href="layout_news_page_delete.php?link_id={$smarty.request.link_id}">
...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="layout_news_page_edit_act.php">
		<div id="LayoutNewsPageTabs">
			<ul>
				<li><a href="#LayoutNewsPageTabs-LayoutNewsPage">{$Site.site_label_layout_news|ucwords} 頁面詳情</a></li>
				<li><a href="#LayoutNewsPageTabs-SEO">SEO</a></li>
				{if $Site.site_module_content_writer_enable == 'Y' && $IsContentAdmin}<li><a href="#LayoutNewsPageTabs-Permission">權限</a></li>{/if}
			</ul>
			<div id="LayoutNewsPageTabs-LayoutNewsPage">
				<div class="AdminEditDetailsBlock">
					<table class="LeftHeaderTable">
						...
						<tr>
							<th> {$Site.site_label_layout_news|ucwords}根 </th>
							<td>
						...
						<tr>
							<th> {$Site.site_label_layout_news|ucwords}分類 </th>
							<td>
								<select id="layout_news_category_id" name="layout_news_category_id">
									<option value="0" {if $LayoutNewsPage.layout_news_category_id == 0}selected="selected"{/if}>所有</option>
