...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
		...
		{foreach from=$NewsCategories item=C}
			<tr class="{if $C.object_is_enable == 'N'}DisabledRow{/if}">
				...
				<td class="AlignCenter">
					...
					<a href="news_category_delete.php?id={$C.news_category_id}" onclick="return DoubleConfirm('警告！\n 所有在此分類中的項目和資料都會被刪除！\n 確定刪除嗎？', '警告！\n真的確定刪除？')" class="ui-state-default ui-corner-all MyButton">
	...
	<a href="news_category_add.php?language_id={$smarty.request.language_id}" class="ui-state-default ui-corner-all MyButton"><span class="ui-icon ui-icon-circle-plus"></span>新增分類</a>
</div>
<br class="clearfloat" />
