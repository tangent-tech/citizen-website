...
<div class="InnerContainer ui-widget ui-corner-all">
	<h2 class="ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top InnerHeader">更改{$Site.site_label_layout_news|ucwords}排版 - {$LayoutNews.layout_news_title|escape:'html'}</h2>
