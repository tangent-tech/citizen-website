...
<h1 class="PageTitle">連結 - {$ObjectLink.object_name|escape:'html'} &nbsp;
	<a onclick="return confirm('警告! \n 確定刪除？')" class="ui-state-default ui-corner-all MyButton" href="link_delete.php?link_id={$smarty.request.link_id}">
