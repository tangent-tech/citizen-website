...
MSDropDown = {
	...
	styles: {
			...
			arrow: 'js/msdropdown/dd_arrow.gif',
			arrowclass: 'msArrow',
	...
	makeAdropDown: function() {
		...
		for(i in alldps) {
			...
			if(values.length>this.getVisibleRows()) childheight = '300';
			var ddhtml = "";
	...
	setSelected: function(id, value, aID, val, imgsrc) {
		...
		if (parentID == 'CurrencySelection' || parentID == 'LanguageSelection' )
			$("#frmTopSelection").submit();
	},
