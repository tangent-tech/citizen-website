...
$smarty->assign('NewsCategory', $NewsCategory);

$_REQUEST['language_id'] = $NewsCategory['language_id'];

$smarty->assign('TITLE', 'Edit Category');
$smarty->display('myadmin/' . $CurrentLang['language_id'] . '/news_category_edit.tpl');