...
$query =	"	INSERT INTO	z_seo_article_mess " .
...
header( 'Location: z_seo_article_submit_mess.php?SystemMessage=' . urlencode(ADMIN_MSG_UPDATE_SUCCESS) . '&ErrorMessage=' . urlencode($ErrorMessage));