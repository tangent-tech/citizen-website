...
$smarty->assign('CurrentTab2', 'order_outstanding_shipment_list');
$smarty->assign('MyJS', 'order_outstanding_shipment_list');
...
$StockTransactionList = inventory::GetStockTransactionList($Site['site_id'], $TotalTransactions, $_REQUEST['page_id'], NUM_OF_TRANSACTIONS_PER_PAGE, 'STOCK_HOLD', $PassShopID);
...
$smarty->assign('TITLE', 'Outstanding Shipment List');
$smarty->display('myadmin/' . $CurrentLang['language_id'] . '/order_outstanding_shipment_list.tpl');