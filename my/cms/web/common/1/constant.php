...
// Jeff 20140703: I orginally believe there should be photo1, photo2, photo3
// But later I find that this is useless because even if photo1 is actually photo2 (same file), we still cannot group them, because we store as different file_id
//	i.e. we cannot tell if red.jpg == red.jpg in this case (at least no easy way to do so)
// 
// e.g. Data: productA(red.jpg + 10g), productB(red.jpg + 20g), productC(blue.jpg + 10g), productD(blue,jpg + 20g)
// Ideally frontend matrix selection should be:
//	color: red.jpg, blue.jpg
//	weight: 10g, 20g
// No, we cannot do this with file_id, it will become
//	color: file-id1.jpg(red), file-id2.jpg(red), file-id3.jpg(blue), file-id4.jpg(blue)
//	weight: 10g, 20g
// So we should use text field to group instead of using file_id
...
$ProductCategoryBasicGroupValidFields = array(
	...
	'p_factory_code' => "Factory Code",
	'p_product_weight' => "Weight",
	'p_product_size' => "Size",
//	'p_product_brand_id' => 'Brand',
	'd_product_color' => 'Color',
	'd_product_packaging' => 'Packaging'
);
