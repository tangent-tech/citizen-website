...
elseif (ENV == 'PRODUCTION') {
	...
	define('BASEDIR',			'/home/citizen/my/cms/');
	define('BASEWEBDIR',		BASEDIR . 'web/');
	define('BASEDIR_HTMLSAFE',	BASEDIR . 'htmlsafe/');
	define('BASEURL',			'http://cms.citizen.com.my/myadmin/');
	define('BASEURL_ELASING',	'http://cms.citizen.com.my/elasing/');
...
elseif (ENV == 'POS') {
	...
	define('BASEDIR',			'/var/www/apps/citizen/my/cms/');
	define('BASEWEBDIR',		BASEDIR . 'web/');
	define('BASEDIR_HTMLSAFE',	BASEDIR . 'htmlsafe/');
	define('BASEURL',			'http://my.citizen-cms.uat.my/myadmin');
	define('BASEURL_ELASING',	'http://my.citizen-cms.uat.my/elasing/');
	define('GIT_REPO_STORAGE_PATH', '/git_repo/production_cms/');
}
