...
if (ENV == 'LOCAL') {
	...
	define('BASEDIR',		'/var/www/apps/citizen/my/web/');

	define('API_BASEURL',	'http://my.citizen-cms.uat.my/api/');
	define('api_login', 	'citizenweb');
	define('api_key',		'4b1835ee5a1f46a4e0c3d2148129990b');
	define('BASEWEBDIR',	BASEDIR . "web/");
	define('SITE_ID',		206);
	define('API_ENV',		'DEVELOPMENT');
	define('BASEURL',		'http://my.citizen.uat.my');
	define('REMOTE_BASEURL','http://my.citizen.uat.my');
	define('ENABLE_LOCAL_CACHE', true);
	define('CACHE_BASEDIR', BASEDIR . '/htmlsafe/localcache/');
	
	// Custom DB
	define('DB_HOST',	'52.77.43.36');
	define('DB_NAME',	'www_citizenmy');
	...
	define('BASEDIR',		'/home/citizen/my/web/');

	define('API_BASEURL',	'http://cms.citizen.com.my/api/');
	define('api_login', 	'citizenweb');
	define('api_key',		'4b1835ee5a1f46a4e0c3d2148129990b');
	define('BASEWEBDIR',	BASEDIR . "web/");
	define('SITE_ID',		206);
	define('API_ENV',		'PRODUCTION');
	define('BASEURL',		'https://www.citizen.com.my');
	define('REMOTE_BASEURL','https://www.citizen.com.my');
	define('ENABLE_LOCAL_CACHE', true);
	define('CACHE_BASEDIR', BASEDIR . '/htmlsafe/localcache/');
...
if(ENV == "DEV") {
	...
	define('API_DB_NAME',	'cache_citizenmy'); // default is c16cmsapi and customized is cms_api_cache
	...
	define('DB_CMS', 'cms_citizenmy'); // default is c16369cms
}
