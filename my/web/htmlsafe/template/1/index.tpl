					...
					<div class="lineup">
						...
						<div class="lineupDetail">
							...
							<p class="btn_01 lineupDetail_btnMore">
								<a href="{$BASEURL}{GetSeoUrl($smarty.const.PRODUCT_ROOT_LINK_ID)}">View all watch lineups</a>
							</p>
...
<!-- 						<p class="related_label">Related Brands </p>
 -->						<ul class="relatedlist clearfix">
			...
			<section>
				<div class="headingLv1Block noBorder">
					<h2 class="headingLv1">Technologies</h2>
				</div>
				<div class="container">
					<div class="techonology">
						<div class="technology_inner">
							...
							<p class="btn_01 technology_btn"><a href="{$TechnologiesBlockContent->block_link_url}">Technologies</a></p>
						</div>
					...
					<div class="container">
						...
						<div class="news_inner">
							...
							<p class="btn_01 news_btnInfo">
								<a href="{$BASEURL}{$ImportantNotices->object_seo_url}">List of important issue</a>
							</p>
						</div>
						*}
			...
			{if $ServiceAndSupport_Left->object_id|intval > 0 || $ServiceAndSupport_Right->object_id|intval > 0}
				<section>
					<div class="headingLv1Block noBorderBottom">
						<h2 class="headingLv1">Service and Support</h2>
					</div>
					<div class="support">
						<div class="container">
