...
<html>
	<head>
		...
		*}
		...
		<script type="text/javascript" charset="utf-8" src="{$BASEURL}/js/scripts/app.js"></script>
			...
			<div class="breadcrumb">
				<ul itemscope itemtype="http://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
						<a itemprop="item" href="{$BASEURL}/index.php"><span itemprop="name">主頁</span></a>
					...
					{else if $MyJS == "Search"}
						...
						<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
							<span itemprop="name">搜索結果 「{$smarty.request.search_text}」</span>
						</li>
