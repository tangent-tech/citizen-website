						...
						<table>
							...
							<tr>
								...
								<td width="75%">
									...
									<img class="tooltipIMG" data-tipcontent="{$BASEURL}/images/warranty/case_sample_tc.jpg" title=""
										 src="{$BASEURL}/images/warranty/button_whatcase_off_tc.jpg" width="120" height="20" alt="What is Case No."/>
							...
							<tr>
								...
								<td>
									...
									<img class="tooltipIMG" data-tipcontent="{$BASEURL}/images/warranty/manufacturer_sample_tc.jpg" title=""
										 src="{$BASEURL}/images/warranty/button_whatmanu_off_tc.jpg" width="182" height="20" alt="What is Manufacturer's No."/>
									<div class="ErrorBlock"></div>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<img class="tooltipIMG" data-tipcontent="{$BASEURL}/images/warranty/model_sample_tc.jpg" title=""
										 src="{$BASEURL}/images/warranty/button_whatmodel_off_tc.jpg" width="126" height="20" alt="What is Model No."/>
									<div class="ErrorBlock"></div>
								</td>
							</tr>
							<tr>
