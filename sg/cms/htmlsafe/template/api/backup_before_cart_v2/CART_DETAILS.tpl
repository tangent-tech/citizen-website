<cart_details>
	...
	<effective_base_price_id>{$Object.effective_base_price_id}</effective_base_price_id>
	<bonus_point_item_id>{$Object.bonus_point_item_id}</bonus_point_item_id>
	<use_bonus_point>{$Object.use_bonus_point}</use_bonus_point>
	<user_balance_use>{$Object.user_balance_use}</user_balance_use>
	...
	<invoice_country_other>{$Object.invoice_country_other|myxml}</invoice_country_other>
	...
	<delivery_country_other>{$Object.delivery_country_other|myxml}</delivery_country_other>
	...
	<total_possible_discount_rule_no_by_discount_code>{$PossibleRuleNo}</total_possible_discount_rule_no_by_discount_code>
	<total_applied_discount_rule_no_by_discount_code>{$AppliedRuleNo}</total_applied_discount_rule_no_by_discount_code>
