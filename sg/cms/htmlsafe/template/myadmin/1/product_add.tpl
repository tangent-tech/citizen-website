...
<h1 class="PageTitle">Add {$Site.site_label_product|ucwords} &nbsp;
									...
									<tr>
										...
										<td>
											{if $Product[$product_group_media_file_field] != 0}
												...
												<input type="checkbox" name="remove_{$product_group_media_file_field}" value="Y" /> Remove <br />
											{/if}
								...
								<tr>
									...
									<td>
										...
										{if $Site.site_product_price_version >= 2}
											Bonus Point Required <input type="text" name="product_bonus_point_required[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.product_bonus_point_required}" />
										{/if}
									</td>
								</tr>
										...
										<tr>
											...
											<td>
												<table>
													<tr>
														<td>
															<input type="radio" class="discount_type" name="discount_type[{$smarty.section.foo.iteration}]" value="0" {if $ProductPriceRow.discount_type == 0}checked="checked"{/if} /> No Discount <br />
															<input type="radio" class="discount_type" name="discount_type[{$smarty.section.foo.iteration}]" value="1" {if $ProductPriceRow.discount_type == 1}checked="checked"{/if} /> <input type="text" name="discount1_off_p[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.discount1_off_p}" maxlength="2" size="2" />% Off <br />
															<input type="radio" class="discount_type" name="discount_type[{$smarty.section.foo.iteration}]" value="2" {if $ProductPriceRow.discount_type == 2}checked="checked"{/if} /> $<input type="text" name="discount2_price[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.discount2_price}"  maxlength="5" size="5" /> for <input type="text" name="discount2_amount[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.discount2_amount}" maxlength="2" size="2" /> <br />
															<input type="radio" class="discount_type" name="discount_type[{$smarty.section.foo.iteration}]" value="3" {if $ProductPriceRow.discount_type == 3}checked="checked"{/if} /> Buy <input type="text" name="discount3_buy_amount[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.discount3_buy_amount}" maxlength="2" size="2" /> Get <input type="text" name="discount3_free_amount[{$smarty.section.foo.iteration}]" value="{$ProductPriceRow.discount3_free_amount}" maxlength="2" size="2" /> Free <br />
														</td>
														<td>
															<input type="radio" class="discount_type" name="discount_type[{$smarty.section.foo.iteration}]" value="4" {if $ProductPriceRow.discount_type == 4}checked="checked"{/if} /> Price Level
