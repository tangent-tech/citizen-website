...
<h1 class="PageTitle">Edit {$Site.site_label_news|ucwords} Category &nbsp;
	<a class="ui-state-default ui-corner-all MyButton" href="news_category_list.php?language_id={$NewsCategory.language_id}">
		<span class="ui-icon ui-icon-arrowreturnthick-1-e"></span> {$Site.site_label_news|ucwords} Category List
	</a>
</h1>
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<h2 class="ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top InnerHeader">{$Site.site_label_news|ucwords} Category Details </h2>
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="news_category_edit_act.php">
		<div class="InnerContent ui-widget-content">
			<table class="LeftHeaderTable">
				<tr>
					<th> {$Site.site_label_news|ucwords} Category Language </th>
					<td>
				...
				<tr>
					<th> {$Site.site_label_news|ucwords} Category Name </th>
