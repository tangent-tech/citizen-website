...
<h1 class="PageTitle">Edit Album Root &nbsp;
...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="album_root_edit_act.php">
		<div id="AlbumRootTabs">
			<ul>
				{if $Site.site_module_content_writer_enable == 'Y' && $IsContentAdmin}<li><a href="#AlbumRootTabsPanel-Permission">Permission</a></li>{/if}
