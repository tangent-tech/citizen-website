...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="z_seo_article_submit_3_act2.php">
		<div class="AdminEditDetailsBlock">
			<table class="LeftHeaderTable">
				<tr>
					<td><input type="text" name="submit_url_1" value="" /></td>
					<td><input type="text" name="submit_url_2" value="" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="radio" name="content_input_no" value="1" checked="check" /></td>
