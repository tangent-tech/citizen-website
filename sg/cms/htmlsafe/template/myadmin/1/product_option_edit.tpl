...
<h1 class="PageTitle">Edit {$Site.site_label_product|ucwords} Option &nbsp;
			...
			<div class="AdminEditDetailsBlock">
				<p>
					<strong>Status:</strong> 
						<input type="radio" name="object_is_enable" value="Y" {if $ProductOption.object_is_enable == 'Y'}checked="checked"{/if}/> Enable
						<input type="radio" name="object_is_enable" value="N" {if $ProductOption.object_is_enable == 'N'}checked="checked"{/if}/> Disable
					<br />
					<strong>Product Option Code:</strong> <input type="text" name="product_option_code" value="{$ProductOption.product_option_code}"/> <br />
				</p>
				<br />
