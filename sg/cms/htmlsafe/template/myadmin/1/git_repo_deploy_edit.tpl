...
<h1 class="PageTitle">Edit Git Deploy Point &nbsp;
	...
	<a class="ui-state-default ui-corner-all MyButton" href="git_repo_edit.php?git_repo_id={$GitRepoDeployInfo.git_repo_id}">
...
<div class="InnerContainer ui-widget ui-corner-all">
	...
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="git_repo_deploy_edit_act.php">
			...
			<div class="AdminEditDetailsBlock">
				<table class="LeftHeaderTable">
					<tr>
						...
						<td> <input type="text" name="git_repo_deploy_name" value="{$GitRepoDeployInfo.git_repo_deploy_name}" size="50" /> </td>
					</tr>
					<tr>
						<th> Linux User of the deploy point (e.g. web123) </th>
						<td> 
							{if $GitRepoDeployInfo.git_repo_deploy_linux_user == null}
								DEFAULT DEPLOY POINT
							{else}
								<input type="text" name="git_repo_deploy_linux_user" value="{$GitRepoDeployInfo.git_repo_deploy_linux_user}" size="50" />
							{/if}
						</td>
					</tr>
					<tr>
						...
						<td> <input type="text" name="git_repo_deploy_branch" value="{$GitRepoDeployInfo.git_repo_deploy_branch}" size="50" /> </td>
					</tr>
				</table>
			</div>
			<input type="hidden" name="git_repo_deploy_id" value="{$smarty.request.git_repo_deploy_id}" />
