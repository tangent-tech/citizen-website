...
<h1 class="PageTitle">網站區塊定義列表</h1>
<div class="InnerContainer ui-widget ui-corner-all">
	<h2 class="ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-top InnerHeader">網站區塊定義詳情</h2>
			...
			<div class="AdminEditDetailsBlock">
				<table class="LeftHeaderTable">
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="site_block_file_delete" value="1" /> 刪除
						</td>
					</tr>
				</table>
				<hr />			
				<table class="TopHeaderTable">
					<tr class="ui-state-highlight">
						<th class="AlignCenter" width="">編號</th>
						<th class="AlignCenter" width="">區塊名稱</th>
						<th class="AlignCenter" width="">區塊描述</th>
						<th class="AlignCenter" width="80">區塊類型</th>
