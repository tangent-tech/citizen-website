...
<h1 class="PageTitle">編輯相簿 (id: {$Album.object_id}) &nbsp;
...
<div class="InnerContainer ui-widget ui-corner-all AdminEditDetailsBlock">
	<form enctype="multipart/form-data" name="FrmEditBlock" id="FrmEditBlock" method="post" action="album_edit_act.php">
		<div id="AlbumTabs">
			<ul>
				<li><a href="#AlbumTabsPanel-CommonData">一般資料</a></li>
				{if $Site.site_module_content_writer_enable == 'Y' && $IsContentAdmin}<li><a href="#AlbumTabsPanel-Permission">權限</a></li>{/if}
								...
								<tr>
									...
									<td>
										{if $Album.$myfieldval != 0}
											...
											檔案大小: {$AlbumFiles[$smarty.section.foo.iteration].size/1024|string_format:"%.2f"}kb <br />
											<input type="checkbox" name="delete_{$myfield}" value="Y" /> 刪除 <br />
										{/if}
