...
<div id="LoginContainer" class="InnerContainer ui-widget ui-widget-content ui-corner-all">
	<h1 class="InnerHeader ui-widget-header ui-helper-reset ui-corner-top" >{$smarty.const.CMS_PRODUCT_NAME} 管理面板</h1>
	<div id="LoginContainerContent" class="InnerContent ui-widget-content ui-helper-reset ui-corner-bottom">
		...
		<form action="login.php" method="post">
			<p> <label for="email">電郵:</label> <input type="text" name="email" id="email" value="{$smarty.request.email|escape:'html'}" /> </p>
