	<div class="ui-tabs ui-widget ui-corner-all ContentContainer">
		<ul id="Menu2ndLevel" class="menu ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			{if $Site.site_module_article_enable == 'Y' && in_array('acl_module_sitemap_show', $EffectiveACL) }
				<li class="ui-state-default ui-corner-top {if $CurrentTab2 == 'language_root'}ui-tabs-selected ui-state-active{/if}"><a href="language_root_list.php">網站地圖</a></li>
				<li class="ui-state-default ui-corner-top {if $CurrentTab2 == 'siteblock'}ui-tabs-selected ui-state-active{/if}"><a href="siteblock.php">網站區塊</a></li>
			{/if}
			{if $Site.site_module_album_enable == 'Y' && in_array('acl_module_album_show', $EffectiveACL)}
				<li class="ui-state-default ui-corner-top {if $CurrentTab2 == 'album'}ui-tabs-selected ui-state-active{/if}"><a href="album_list.php">相簿</a></li>
			{/if}
