...
$cart->UpdateProductCart($_REQUEST['product_id'], intval($_REQUEST['product_qty']), $_REQUEST['product_option_id'], $_REQUEST['product_price_id'], $_REQUEST['cart_content_custom_key'], $_REQUEST['cart_content_custom_desc']);
