...
$smarty->assign('MyJS', 'discount_postprocess_rule_add');
...
$smarty->assign('TITLE', 'Add Discount Postprocess Rule');
$smarty->display('myadmin/' . $CurrentLang['language_id'] . '/discount_postprocess_rule_add.tpl');