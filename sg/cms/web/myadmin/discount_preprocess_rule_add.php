...
$smarty->assign('MyJS', 'discount_preprocess_rule_add');
...
$smarty->assign('TITLE', 'Add Discount Preprocess Rule');
$smarty->display('myadmin/' . $CurrentLang['language_id'] . '/discount_preprocess_rule_add.tpl');