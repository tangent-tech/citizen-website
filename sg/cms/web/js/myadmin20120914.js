...
*/
	if (MyJS == 'product_tree' || MyJS == 'product_category_tree') {
		...
		$("#AddMorePostprocessDiscountLevelLink").click(function() {
			var ExtraRow = $('.PostprocessDiscountLevelInput').eq(0).clone();

			var TheInputIndex = parseInt($('#PostprocessDiscountLevelContainer').attr('data-theinputindex'));
			TheInputIndex++;
			$('#PostprocessDiscountLevelContainer').attr('data-theinputindex', TheInputIndex);
			...
			ExtraRow.appendTo('#PostprocessDiscountLevelContainer table');
			ExtraRow.show();
		});

		$("#AddMorePostprocessDiscountLevelLink").click();
		$(".RemovePostprocessDiscountLevelLink").live('click', function() {
			if ($(".RemovePostprocessDiscountLevelLink").size() > 1)
				$(this).closest('tr').remove();
		});
	}
		...
		$("#AddMoreProductPriceLevelLink").click();
		$(".RemoveProductPriceLevelLink").live('click', function() {
			if ($(".RemoveProductPriceLevelLink").size() > 1)
				$(this).closest('tr').remove();
		});
