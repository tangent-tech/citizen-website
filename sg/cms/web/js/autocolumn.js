...
//			$inBox.append($("<div class='first last column' style='width:100%; padding: 0px; float: " + options.float + ";'></div>")); //"
...
//			$inBox.append($("<div style='width:" + (Math.round(1000 / numCols)/10)+ "%; padding: 0px; float: " + options.float + ";'></div>")); //"
...
//					$inBox.append($("<div class='" + className + "' style='width:" + (Math.round(1000 / numCols)/10)+ "%; float: " + options.float + ";'></div>")); //"
				}
