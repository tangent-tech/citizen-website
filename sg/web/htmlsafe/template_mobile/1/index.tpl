		...
		<main>
			...
			<div class="container">
				...
				<p class="btn_01 lineup mt30">
					<a href="{$BASEURL}{GetSeoUrl($smarty.const.PRODUCT_ROOT_LINK_ID)}"><span>View all watch lineups</span></a>
				</p>

				<div class="related">
					<p class="related_label">Related Brands</p>
			...
			<div class="philosophy">
				<div class="philosophy_inner">
				  ...
				  <p class="btn_01 philosophy_btn"><a href="{$AboutCITIZEN->block_link_url}">About CITIZEN</a></p>
				</div>
			</div>

			<div class="techonology">
				<div class="technology_inner">
					<p class="technology_logo">TECHNOLOGY</p>
					...
					<p class="btn_01 technology_btn">
						<a href="{$TechnologiesBlockContent->block_link_url}"><span>Technologies</span></a>
					</p>
				</div>
			</div>
			...
			<section class="js-readMoreSPNews">
				...
				<div class="container">
					<div class="btn_01 readMore_btn mt30">
						<a href="javascript:;" class="js-readMoreBtn"><span>View More</span></a>
					</div>
				</div>
			</section>
			...
			<section class="js-readMore">
				<div class="headingLv1Block noBorderBottom">
				  <h1 class="headingLv1">Relevant Video</h1>
				</div>
			...
			{if $MobileServiceAndSupport_Left->object_id|intval > 0 || $MobileServiceAndSupport_Right->object_id|intval > 0}
				<section>
					<div class="headingLv1Block noBorderBottom">
					  <h1 class="headingLv1">Service and Support</h1>
					</div>
