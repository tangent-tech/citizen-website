					...
					<div class="pager clearfix">
						<p class="pager_item">The search result of "<span class="pager_keyword">{$smarty.request.search_text}</span>" is </p>
						<p class="pager_item"><span class="pager_number">{$SearchResult->total_no_of_objects}</span> cases.</p>
