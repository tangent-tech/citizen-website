				...
				<section>
					...
					<form id="WarrantyRegistrationForm" class="WarrantyForm" action="{$BASEURL}/warranty_part1_act.php" method="POST">
						<table>
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Sex</div>
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Age</div>
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Education</div>
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Occupation</div>
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Income</div>
									<ul>
										<li><input type="radio" name="q5_income" value="HKD9,999 or below"/>HKD9,999 or below </li>
										<li><input type="radio" name="q5_income" value="HKD10,000-19,999"/>HKD10,000-19,999</li>
										<li><input type="radio" name="q5_income" value="HKD20,000-29,999"/>HKD20,000-29,999</li>
										<li><input type="radio" name="q5_income" value="HKD30,000-39,999"/>HKD30,000-39,999</li>
										<li><input type="radio" name="q5_income" value="HKD40,000 or above"/>HKD40,000 or above </li>
									</ul>
									<div class="ErrorBlock"></div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Reason(s) you purchased CITIZEN Watch</div>
									...
									<ul>
										...
										<li><input type="checkbox" name="q6_reason_pur[]" value="Dealers/Salespersons Recommendation"/>Dealers/Salespersons Recommendation</li>
										<li><input type="checkbox" name="q6_reason_pur[]" value="Friends Recommendation"/>Friends Recommendation</li>
										<li>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Location you purchased CITIZEN watch</div>
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">Channel(s) you received information about CITIZEN</div>
									(Can select more than one answer) 
									<ul>
							...
							<tr>
								<td>
									<div class="WarrantyFormFieldName">3 Brands of watch you<br/>want to own</div>
