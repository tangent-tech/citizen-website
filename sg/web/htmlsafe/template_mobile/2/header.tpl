			...
			<header role="banner">
				...
				<div class="header_func">
					...
					<p class="gnavi_toggle js-drawerBtn">
					  <a href="javascript:;" class=""><span>選單</span></a>
					</p>
				</div>
												...
												<div class="js-accordionTarget">
													<div class="accordion_detail">
														<ul>
															...
															{/foreach}
															<li><a href="{GetSeoUrl($smarty.const.PRODUCT_ROOT_LINK_ID)}">腕錶系列</a></li>
														</ul>
													</div>
												</div>
					...
					<ul class="search_itemList">
						<li class="search_item">
							<ul class="search_kwButtonList">
								...
								<li class="search_kwButtonList_item">
									<input type="submit" value="搜尋" class="search_moreButton">
								</li>
							</ul>
						</li>
					</ul>
