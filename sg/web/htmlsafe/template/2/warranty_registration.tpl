					...
					<form id="WarrantyRegistrationForm" class="WarrantyForm" action="{$BASEURL}/warranty_part1_act.php" method="POST">
						<table>
							...
							<tr>
								...
								<td>
									<ul>
										<li class="WidthAuto"><input type="radio" name="q5_income" value="港幣9,999或以下"/>港幣9,999或以下 </li>
										<li class="WidthAuto"><input type="radio" name="q5_income" value="港幣10,000 - 19,999"/>港幣10,000 - 19,999</li>
										<li class="WidthAuto"><input type="radio" name="q5_income" value="港幣20,000 - 29,999"/>港幣20,000 - 29,999</li>
										<li class="WidthAuto"><input type="radio" name="q5_income" value="港幣30,000 - 39,999"/>港幣30,000 - 39,999</li>
										<li class="WidthAuto"><input type="radio" name="q5_income" value="港幣40,000或以上"/>港幣40,000或以上 </li>
									</ul>
									<div class="ErrorBlock"></div>
								</td>
							</tr>
							<tr>
								<th>您購買CITIZEN手錶的原因</th>
								<td>
									(可選多項) 
									<ul>
										...
										<br/>
										<li class="WidthAuto"><input type="checkbox" name="q6_reason_pur[]" value="經銷商/售貨員推介"/>經銷商/售貨員推介</li>
										<li class="WidthAuto"><input type="checkbox" name="q6_reason_pur[]" value="朋友推介"/>朋友推介</li>
										<li class="WidthAuto">
