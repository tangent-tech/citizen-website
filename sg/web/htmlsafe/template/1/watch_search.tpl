	...
	<div class="main">		
		<main>
			...
			<div class="container">
				...
				<p class="align-center mb45">Please choose your preference(s) </p>
				...
				<ul class="termsTable clearfix js-optionWrap">
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSKudoOption" class="js-openModal_inline">Movement</a>
						</p>
					...
					{*Denpa Search*}
					<li class="termsTable_item">
						<p class="termsTable_category termsTable_category_twoLine">
							<a href="#JSDenpaOption" class="js-openModal_inline">Signal<br/>Reception</a>
						</p>
						<div class="termsTable_selectCategory">
						...
						<div id="JSDenpaOption" class="modal mfp-hide JSSearchConditionOption">
							...
							<ul class="modalInputList clearfix">
								{foreach $DenpaSearchOption as $k=>$v}
									<li class="modalInputList_item">
										<input type="checkbox" id="denpa_input_{$k}" data-tag-name="{$v.tag_name_en}" data-value="{$v.name_en}"/>
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSCaseOption" class="js-openModal_inline">Case</a>
						</p>
						<div class="termsTable_selectCategory">
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSStrapOption" class="js-openModal_inline">Strap</a>
						</p>
						<div class="termsTable_selectCategory">
					...
					<li class="termsTable_item">
						<p class="termsTable_category termsTable_category_twoLine">
							<a href="#JSWaterResistantOption" class="js-openModal_inline">Water<br/>Resistant</a>
						</p>
						<div class="termsTable_selectCategory">
						...
						<div id="JSWaterResistantOption" class="modal mfp-hide JSSearchConditionOption">
							...
							<ul class="modalInputList clearfix">
								{foreach $WaterResistantSearchOption as $k=>$v}
									<li class="modalInputList_item">
										<input type="checkbox" id="water_resistant_input_{$k}" data-tag-name="{$v.tag_name_en}" data-value="{$v.name_en}"/>
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSGlassOption" class="js-openModal_inline">Glass</a>
						</p>
						<div class="termsTable_selectCategory">
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSPriceOption" class="js-openModal_inline">Price</a>
						</p>
						<div class="termsTable_selectCategory">
					...
					<li class="termsTable_item">
						<p class="termsTable_category">
							<a href="#JSFeaturesOption" class="js-openModal_inline">Features</a>
						</p>
						<div class="termsTable_selectCategory">
						...
						<div id="JSFeaturesOption" class="modal mfp-hide JSSearchConditionOption">
							...
							<ul class="modalInputList clearfix">
								{foreach $FeaturesSearchOption as $k=>$v}
									<li class="modalInputList_item">
										<input type="checkbox" id="features_input_{$k}" data-tag-name="{$v.tag_name_en}" data-value="{$v.field_name}"/>
				...
				<div class="termsTable_noSelect">
					<p class="termsTable_noSelect_text">No specific preference.</p>
				</div>
							...
							<div class="brand_text">
								...
								<p class="brand_link">
									<a href="{$B->block_link_url}" target="_blank">
										Click here for details <img src="{$BASEURL}/images/common/icon_brank_01.png" width="13" height="10" alt="" class="icon_brank_01">
									</a>
								</p>
							</div>
						</div>
...
<!-- 					<div class="sort">
						...
						<dl id="js-sort_buttonList" class="sort_buttonList clearfix">
							<dt class="sort_label">Price Sort</dt>
					...
					<div class="js-displayItem">
						<div id="AjaxSearchProductArea" class="columnWrap lineupWrap column5">
