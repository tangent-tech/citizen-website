...
;(function($, undefined) {
  NewsBitByBit = (function() {
    ...
    checkNoMore = function(b){
      if(!b){
        root.find(button).parent().css({'display':'none'});
      }
    },
...
var NewsBitByBitSPNews = NewsBitByBitSPNews || {};
;(function($, undefined) {
  NewsBitByBitSPNews = (function() {
    var currentCount = 0,
    root = '.js-readMoreSPNews',
    list = '.js-readMoreItem',
    button = '.js-readMoreBtn',
    busy = false,
    accomplished = false,
